...
//				System.out.println(p.diff_main("12352我2", "12332他2",true,10));
	...
	public void initView() {
		...
		gridBagLayout.rowWeights = new double[] { 3, 0, 2 };// 初始化布局
		...
		taRsd.setLineWrap(true);// 激活自动换行功能
		taRsd.setWrapStyleWord(true);// 激活断行不断字功能
		...
		GridBagConstraints gbc_rsd = new GridBagConstraints(); // 设置单元格的属性
		...
		taDst.setLineWrap(true);// 激活自动换行功能
		taDst.setWrapStyleWord(true);// 激活断行不断字功能
		...
		GridBagConstraints gbc_dst = new GridBagConstraints(); // 设置单元格的属性
		...
		GridBagConstraints gbc_compare = new GridBagConstraints(); // 设置单元格的属性
...
//		((myJTextJPane) tpCompareResult).setDocs("111sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss",Color.RED,false,20);
		...
		GridBagConstraints gbc_compareR = new GridBagConstraints(); // 设置单元格的属性
